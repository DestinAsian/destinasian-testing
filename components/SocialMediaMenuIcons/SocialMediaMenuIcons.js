...
import styles from './SocialMediaMenuIcons.module.scss'
import { SOCIAL_MEDIA_URLS } from '@/constants/socialMediaUrl'

let cx = classNames.bind(styles)

export default function SocialMediaMenuIcons() {
  const { linkedin, facebook, instagram, twitter } = SOCIAL_MEDIA_URLS

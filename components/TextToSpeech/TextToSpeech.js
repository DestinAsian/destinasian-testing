        ...
        {textToRead && (
          <>
            ...
            <button
              ...
              aria-label={isPlaying ? 'Pause Reading' : 'Listen to this story'}
            >
              <span className={cx('tts-button-icon')} aria-hidden="true">
                {!isPlaying ? (
                  <svg
                    width="50"
                    height="69"
              ...
              <span className={cx('tts-button-text')}>
                <span className={cx('tts-button-text-sizer')}>
                  Listen to this story
                </span>

                <span className={cx('tts-button-text-label')}>
                  {isPlaying ? 'Pause Reading' : 'Listen to this story'}
                </span>
              </span>
            </button>
          </>

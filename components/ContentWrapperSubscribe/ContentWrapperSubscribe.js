...
import styles from './ContentWrapperSubscribe.module.scss'
...
export default function ContentWrapperSubscribe({ content, children }) {
  ...
  return (
    <article className={cx('component')}>
      ...
      />
      {children}
      <Button className={cx('buy-button')}>{'Buy this Issue'}</Button>
    </article>
  )
}

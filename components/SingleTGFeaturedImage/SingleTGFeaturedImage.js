...
import styles from './SingleTGFeaturedImage.module.scss'
import dynamic from 'next/dynamic'
// Import Components
const TGMenu = dynamic(() => import('@/components/TGMenu/TGMenu'))

let cx = className.bind(styles)

export default function SingleTGFeaturedImage({
  mainLogo,
  databaseId,
  uri,
  isTGNavShown,
...
210 215 210 3 0 195 -190 427 -422z"
      ...
      {/* Full menu */}
      <div
        className={cx(['full-menu-wrapper', isTGNavShown ? 'show' : undefined])}
      >
        <TGMenu
          mainLogo={mainLogo}

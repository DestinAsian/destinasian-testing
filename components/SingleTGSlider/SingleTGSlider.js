...
export default function SingleTGSlider({
  images,
  nextUri,
  sliderTG,
  isSliderMounted,
  ...
  useEffect(() => {
    if (sliderTG.current && sliderTG.current.swiper) {
  ...
  useEffect(() => {
    if (isSliderMounted) {
      sliderTG.current.swiper.update()
    }
  ...
  return (
    <>
      <Swiper
        ...
        pagination={{
          clickable: true,
          el: '.swiper-tg-custom-pagination',
          clickable: true,
...
-1102 1101 -1140 1137 -1198 1159 -67 25 -189 34 -248 20z"
      ...
      <div className="swiper-tg-custom-pagination"></div>
    </>
  )
}
